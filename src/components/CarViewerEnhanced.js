...
// Simple car material
const CarMaterial = ({ color = '#ffffff', metalness = 0.6, roughness = 0.25 }) => {
  return (
...
// Glass material
const GlassMaterial = ({ opacity = 0.8 }) => {
  return (
    <meshStandardMaterial
      color="#111827"
      opacity={opacity}
...
// Enhanced Honda Accord Component
  ...
  return (
    <group position={position} rotation={[0, 0, rotation]}>
      ...
      <mesh castShadow receiveShadow>
        ...
        <meshStandardMaterial color={highlighted ? "#dc2626" : "#c0c0c0"} metalness={0.8} roughness={0.2} />
      </mesh>
...
// Main CarViewerEnhanced Component
function CarViewerEnhanced({ highlightedPart, onSystemSelect }) {
...
export default CarViewerEnhanced;
